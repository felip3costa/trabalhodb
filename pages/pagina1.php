    ...
    <div class="row">
        <div class="col-md-5">
            <div class="">
                ...
                <div>
                    ...
                    <hr>
                    <code>select count(*) as "consultas" from consulta where data_exame >= "2020-12-12" and data_exame <= "2021-03-25"</code>
                </div>
            </div>
        ...
        <div class="col-md-7">
            <table class="table">
                ...
                <tr>
                    <th scope="row"></th>
                    <td><?php echo $resposta['consultas']; ?></td>
                    <td>Nào conseguimos</td>
                </tr>
                <?php endforeach; ?>
                </tbody>
            </table>
