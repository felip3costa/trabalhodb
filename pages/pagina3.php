        ...
        <div class="col-md-5">
            <div class="">
                ...
                <div>
                    ...
                    <hr>
                    <code>select fk_medico_nome, sum(recebido_por_medico) as "pago" from trabalhodb.info_pagamento group by fk_medico_nome;</code>
                </div>
            </div>
        ...
        <div class="col-md-7">
            <table class="table">
                ...
                <tr>
                    ...
                    <td><?php echo 'R$ ', $resposta['pago']; ?></td>
                </tr>
                <?php endforeach; ?>
                </tbody>
            </table>
