        ...
        <div class="col-md-5">
            <div class="">
                ...
                <div>
                    ...
                    <hr>
                    <code>select fk_medico_nome, sum(recebido_por_medico + comissao_clinica) as "soma" from trabalhodb.info_pagamento group by fk_medico_nome</code>
                </div>
            </div>
        ...
        <div class="col-md-7">
            <table class="table">
                ...
                <tr>
                    ...
                    <td><?php echo 'R$ ', $resposta['soma']; ?></td>
                </tr>
                <?php endforeach; ?>
                </tbody>
            </table>
