        ...
        <div class="col-md-5">
            <div class="">
                ...
                <div>
                    ...
                    <hr>
                    <code>SELECT fk_medico_nome, COUNT( * ) FROM consulta GROUP BY fk_cliente_nome ORDER BY COUNT( * ) DESC;</code>
                </div>
            </div>
        ...
        <div class="col-md-7">
            <table class="table">
                ...
                <tr>
                    ...
                    <td><?php echo $resposta['clientes']; ?></td>
                </tr>
                <?php endforeach; ?>
                </tbody>
            </table>
