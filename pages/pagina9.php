    ...
    <div class="row">
        <div class="col-md-5">
            <div class="">
                ...
                <div>
                    ...
                    <hr>
                    <code>select AVG(idade) from cliente</code>
                </div>
            </div>
        ...
        <div class="col-md-7">
            <table class="table">
                ...
                <tr>
                    <th scope="col">#</th>
                    <th scope="col">Média das idades</th>
                ...
                <tr>
                    <th scope="row"></th>
                    <td><?php echo $resposta['media']; ?></td>
                    <td>Não conseguimos fazer</td>
                </tr>
                <?php endforeach; ?>
                </tbody>
            </table>
