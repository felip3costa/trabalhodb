        ...
        <div class="col-md-5">
            <div class="">
                ...
                <div>
                    ...
                    <hr>
                    <code>select fk_cliente_nome, exame_realizado, data_exame, doenca_cronica from consulta where doenca_cronica = True and date_add(data_exame, interval 6 month)</code>
                </div>
            </div>
        ...
        <div class="col-md-7">
            <table class="table">
                ...
                <tr>
                    ...
                    <td><?php echo $resposta['data_exame']; ?></td>
                    <td><?php if ($resposta['doenca_cronica'] == 1) echo 'Doença Crônica' ; ?></td>
                </tr>
                <?php endforeach; ?>
                </tbody>
            </table>
